 ...
 */
class MulticastCacheStrategy : public Strategy
                        , public ProcessNackTraits<MulticastCacheStrategy>
{
public:
  explicit
  MulticastCacheStrategy(Forwarder& forwarder, const Name& name = getStrategyName());
